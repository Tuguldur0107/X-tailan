...
export default function Login() {
  ...
  const onSubmit = (e) => {
    ...
    toast({
      title: "Mock login",
      description: "Backend дараагийн шатанд.",
      status: "success",
    });
    nav("/home");
  };
      ...
      <VStack spacing={6} align="stretch">
        ...
        <Box>
          ...
          <Text mt={1} color={muted}>
            X-SENDER рүү нэвтрэх (mock). Албан backend дараа холбогдоно.
          </Text>
        </Box>
          ...
          <VStack spacing={5} align="stretch">
            ...
            <Button
              ...
              onClick={(e) => {
                ...
                toast({
                  title: "Facebook mock",
                  description: "OAuth дараагийн шатанд.",
                  status: "info",
                });
              }}
            >
